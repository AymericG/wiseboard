...
// function wrapToRect(container: svg.Container, text: string, padding: number, linePadding: number) {

//     const fontSize = 30;
//     const x: any = container.x;
//     // const y = parseInt(boxObject.getAttribute('y'), 10);
//     const boxWidth = container.width();
//     const lineHeight = fontSize + linePadding;

//     // Clone the original text node to store and display the final wrapping text.
//    const wrapping = document.createElement('div');        // False means any TSPANs in the textnode will be discarded
// //    wrapping.setAttributeNS(null, 'x', (x + padding).toString());
// //    wrapping.setAttributeNS(null, 'y', (y + padding).toString());

//     // Make a copy of this node and hide it to progressively draw, measure and calculate line breaks.
//    let testing = document.createElement('div');
//    testing.style.visibility = 'hidden';  // Comment this out to debug

//    let testingTSPAN: any = document.createElementNS(null, 'tspan');
//    let testingTEXTNODE: any = document.createTextNode(text);
...
//       testWidth = testing.getBoundingClientRect().width;

//       if ((testWidth + 2 * padding) > boxWidth) {

//         testingTSPAN = document.createElementNS('http://www.w3.org/2000/svg', 'tspan');
//         testingTSPAN.setAttributeNS(null, 'x', (x + padding).toString());
//         testingTSPAN.setAttributeNS(null, 'dy', lineHeight.toString());
...
//         // lineCounter++;
//       } else {
//         // enough width to add word
//         line = line2;
//       }
//     }

//     testingTSPAN = document.createElementNS('http://www.w3.org/2000/svg', 'tspan');
//     testingTSPAN.setAttributeNS(null, 'x', x + padding);
...
//     const element = container.element('foreignObject', svg.Parent);
//     element.node.appendChild(wrapping);
//     return element;
// }